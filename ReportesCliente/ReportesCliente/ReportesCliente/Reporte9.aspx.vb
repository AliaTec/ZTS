...
Partial Public Class Reporte9

    Inherits System.Web.UI.Page

    Public RPT As New ProvisionesPorEmpresa
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        RPT.DataSource = New DataDynamics.ActiveReports.DataSources.OleDBDataSource("Provider=SQLOLEDB.1;" + sConnection, "spq_nomProvisiones @IdRazonSocial = <%IdRazonSocial%>,@IdTipoNominaAsig=<" & _
        ...
        Try
            ...
            strName = "Provisiones" + Context.Session("UID").trim + Date.Now.Day.ToString + Date.Now.Month.ToString + Date.Now.Year.ToString + Date.Now.Minute.ToString + Date.Now.Second.ToString + ".xls"
