...
Partial Public Class Reporte8

    Inherits System.Web.UI.Page

    Public RPT As New CentroCostosEmpleado
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        RPT.DataSource = New DataDynamics.ActiveReports.DataSources.OleDBDataSource("Provider=SQLOLEDB.1;" + sConnection, "sp_CentroCostosEmpledos @IdRazonSocial = <%IdRazonSocial%>,@IdTipoNominaAsig=<" & _
        ...
        Try
            ...
            strName = "CentroCostosEmpleado" + Context.Session("UID").trim + Date.Now.Day.ToString + Date.Now.Month.ToString + Date.Now.Year.ToString + Date.Now.Minute.ToString + Date.Now.Second.ToString + ".xls"
