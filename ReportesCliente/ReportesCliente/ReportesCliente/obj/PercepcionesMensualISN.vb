...
Public Class PercepcionesMensualISN
    ...
    Private Sub PercepcionesMensualISN_ReportStart(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.ReportStart
        ...
        sConnection, "spq_ISNper @IdRazonSocial = " + Me.Parameters("IdRazonSocial").Value + "," & _
