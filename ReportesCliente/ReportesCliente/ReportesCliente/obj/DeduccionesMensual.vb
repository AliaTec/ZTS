...
Public Class DeduccionesMensual
    ...
    Private Sub DeduccionesMensual_ReportStart(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.ReportStart
        ...
        sConnection, "spq_nomExeMensual @IdRazonSocial = " + Me.Parameters("IdRazonSocial").Value + "," & _
