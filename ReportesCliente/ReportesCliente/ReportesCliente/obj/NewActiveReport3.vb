...
Public Class NewActiveReport3
    ...
    Public Sub NewActiveReport3_ReportStart(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.ReportStart
        ...
        Me.DataSource = New DataDynamics.ActiveReports.DataSources.OleDBDataSource("Provider=SQLOLEDB.1;" & _
                sConnection, "sp_Reporte_CartaPensionMc @IdRazonSocial = " + Me.Parameters("IdRazonSocial").Value + "," & _
