...
Public Class EmpresaGravadosExentosPeriodo
    ...
    Private Sub Empresa_ReportStart(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.ReportStart
        ...
        sConnection, "spq_nomGraExeAuPeriodo @IdRazonSocial = " + Me.Parameters("IdRazonSocial").Value + "," & _
