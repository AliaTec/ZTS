...
Public Class DeduccionesMensualISN
    ...
    Private Sub DeduccionesMensualISN_ReportStart(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.ReportStart
        ...
        sConnection, "spq_ISNRes @IdRazonSocial = " + Me.Parameters("IdRazonSocial").Value + "," & _
