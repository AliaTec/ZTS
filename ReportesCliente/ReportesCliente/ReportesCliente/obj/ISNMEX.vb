...
Public Class ISNMEX
    ...
    Public Sub ISNMEX_ReportStart(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.ReportStart
        ...
        Me.DataSource = New DataDynamics.ActiveReports.DataSources.OleDBDataSource("Provider=SQLOLEDB.1;" & _
                sConnection, "spq_nomISNMEX @IdRazonSocial = " + Me.Parameters("IdRazonSocial").Value + "," & _
        ...
        Dim SubReportePercepcionesMensualISN As New PercepcionesMensualISNMEX
        ...
        '                                  nombre del subreporte
        Dim SubReporteDeduccionesMensualISN As New DeduccionesMensualISNMEX
