...
Public Class PercepcionesEmpleadosPorConcepto
    ...
    Private Sub PercepcionesEmpleadosPorConcepto_ReportStart(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.ReportStart
        ...
        sConnection, "spq_nomConceptoEmpleadoDetalle @IdRazonSocial = " + Me.Parameters("IdRazonSocial").Value + "," & _
