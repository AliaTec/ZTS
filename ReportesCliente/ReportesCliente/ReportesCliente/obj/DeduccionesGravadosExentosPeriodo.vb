...
Public Class DeduccionesGravadosExentosPeriodo
    ...
    Private Sub Deducciones_ReportStart(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.ReportStart
        ...
        sConnection, "spq_nomExenPeriodo @IdRazonSocial = " + Me.Parameters("IdRazonSocial").Value + "," & _
