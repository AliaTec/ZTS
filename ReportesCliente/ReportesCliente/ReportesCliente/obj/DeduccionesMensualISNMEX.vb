...
Public Class DeduccionesMensualISNMEX
    ...
    Private Sub DeduccionesMensualISNMEX_ReportStart(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.ReportStart
        ...
        sConnection, "spq_ISNResMEX @IdRazonSocial = " + Me.Parameters("IdRazonSocial").Value + "," & _
