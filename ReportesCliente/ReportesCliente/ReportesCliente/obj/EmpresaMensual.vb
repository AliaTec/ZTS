...
Public Class EmpresaMensual
    ...
    Private Sub EmpresaMensual_ReportStart(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.ReportStart
        ...
        sConnection, "spq_nomGraExeAuMensual @IdRazonSocial = " + Me.Parameters("IdRazonSocial").Value + "," & _
