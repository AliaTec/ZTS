...
Public Class PercepcionesMensual
    ...
    Private Sub PercepcionesMensual_ReportStart(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.ReportStart
        ...
        sConnection, "spq_nomGranMensual @IdRazonSocial = " + Me.Parameters("IdRazonSocial").Value + "," & _
