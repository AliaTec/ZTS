...
Partial Public Class ExentosGravadosMensual
    ...
    Private Sub InitializeComponent()
        ...
        Me.Label1.Text = "LISTADO DE IMPORTES GRAVADOS Y EXENTOS MENSUAL"
        Me.Label1.Top = 0.0!
