<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Reporte6.aspx.vb" Inherits="ReportesCliente.Reporte6" %>
	...
	<body>
		<form id="Form1" name="Form1" method="post" runat="server">
            ...
            <asp:Label ID="ligaExcel" runat="server" name="ExportarExcel"></asp:Label>
 		    <ActiveReportsWeb1:WebViewer id="WebViewer6" runat="server" height="696" width="1120" ViewerType="AcrobatReader"></ActiveReportsWeb1:WebViewer>
		</form>
	</body>
</HTML>
