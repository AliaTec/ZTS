...
Partial Public Class Reporte3

    Inherits System.Web.UI.Page

    Public RPT As New NewActiveReport1
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        RPT.DataSource = New DataDynamics.ActiveReports.DataSources.OleDBDataSource("Provider=SQLOLEDB.1;" + sConnection, "sp_Reporte_CartaAsimiladosMc @IdRazonSocial = <%IdRazonSocial%>,@IdTipoNominaAsig=<" & _
